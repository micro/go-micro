...
func testPool(t *testing.T, size int, ttl time.Duration, idle time.Duration, ms int) {
	// setup server
...
func TestGRPCPool(t *testing.T) {
	testPool(t, 0, time.Minute, time.Minute, 2)
	testPool(t, 2, time.Minute, time.Minute, 1)
}
