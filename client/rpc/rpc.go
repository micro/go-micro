...
func (r *rpcClient) call(ctx context.Context, address string, req client.Request, resp interface{}, opts client.CallOptions) error {
...
func (r *rpcClient) stream(ctx context.Context, address string, req client.Request, opts client.CallOptions) (client.Stream, error) {
	msg := &transport.Message{
		Header: make(map[string]string),
	}
