...
<img src="/images/generated/developer-experience.png" alt="micro chat terminal" style="width: 100%; border-radius: 8px; margin: 1rem 0 1.5rem;" />
...
resp, _ := ai.Generate(ctx, model, &ai.Request{Prompt: "list all users", Tools: discovered, History: hist})
...
hist := ai.NewHistory(50)
resp, _ := ai.Generate(ctx, m, &ai.Request{Prompt: userInput, Tools: discovered, History: hist})
