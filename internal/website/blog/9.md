...
<img src="/images/generated/blog-agents-demo.png" alt="Service orchestration concept" style="width: 100%; border-radius: 8px; margin: 1rem 0 1.5rem;" />
...
3. Call `ai.Generate()` with history until the LLM stops requesting tool calls
...
broker.Subscribe("user.created", func(e broker.Event) error {
    ...
    resp, _ := ai.Generate(ctx, m, &ai.Request{Prompt: prompt, SystemPrompt: "You are a service orchestrator.", Tools: discovered, History: hist})
