...
func TestProvider_Stream(t *testing.T) {
	...
	stream, err := p.Stream(context.Background(), &model.Request{
...
func TestProvider_Registration(t *testing.T) {
	m := model.New("gemini", model.WithAPIKey("test"))
	if m == nil {
		t.Fatal("model.New('gemini') returned nil — provider not registered")
	}
	if m.String() != "gemini" {
