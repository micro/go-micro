...
func (h *httpClient) Local() string {
	return h.local
}

func (h *httpClient) Remote() string {
	return h.remote
}

func (h *httpClient) Send(m *transport.Message) error {
...
func (h *httpClient) Recv(m *transport.Message) error {
	if m == nil {
...
func (h *httpSocket) Local() string {
	return h.local
}

func (h *httpSocket) Remote() string {
	return h.remote
}

func (h *httpSocket) Recv(m *transport.Message) error {
	if m == nil {
		return errors.New("message passed in is nil")
	}
...
func (h *httpSocket) Send(m *transport.Message) error {
	if h.r.ProtoMajor == 1 {
		rsp := &http.Response{
			Header:        h.r.Header,
...
func (h *httpSocket) error(m *transport.Message) error {
	if h.r.ProtoMajor == 1 {
		rsp := &http.Response{
			Header:        make(http.Header),
			Body:          ioutil.NopCloser(bytes.NewReader(m.Body)),
...
func (h *httpListener) Accept(fn func(transport.Socket)) error {
	// create handler mux
